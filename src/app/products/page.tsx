            ...
            <div className="relative pt-44 pb-20 overflow-hidden bg-white">
                ...
                <div className="container mx-auto px-6 md:px-12 relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <h1 className="text-2xl md:text-[90px] font-black text-[#003580] uppercase tracking-tighter leading-[0.85] mb-10">
                            The Elite <br />
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-10 border-l-[6px] border-blue-50 pl-10 ml-1">
                            <p className="text-sm md:text-xl text-[#4A5568] font-medium max-w-xl leading-relaxed opacity-80">
