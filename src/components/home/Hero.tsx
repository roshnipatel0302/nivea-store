            ...
            <div className="container mx-auto px-6 md:px-12 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    >
                        ...
                        <h1 className="text-[2.5rem] md:text-[80px] font-black text-[#003580] leading-[0.9] tracking-tighter mb-8">
                            Pure Care. <br />
                            <span className="text-gradient-nivea">Daily Glow.</span>
                        </h1>

                        <p className="text-sm md:text-xl text-[#4A5568] font-medium leading-relaxed max-w-lg mb-12 opacity-80">
